...
namespace dxdoth
{
    namespace Details // code in Details namespace is for internal use within the library
    {
        ...
        #define DXDOTH_DEFINE_CLASS(THIS_CLASS, BASE_CLASS, INTERFACE)                                                                      \
        THIS_CLASS() {}                                                                                                                        \
        ...
        #define DXDOTH_DEFINE_STRUCT(THIS_STRUCT, BASE_STRUCT)                                          \
    ...
    struct SizeU
    {
        DXDOTH_DEFINE_STRUCT(SizeU, D2D1_SIZE_U)
    ...
    struct SizeF
    {
        DXDOTH_DEFINE_STRUCT(SizeF, D2D1_SIZE_F)
    ...
    struct Point2F
    {
        DXDOTH_DEFINE_STRUCT(Point2F, D2D1_POINT_2F)
    ...
    struct Point2U
    {
        DXDOTH_DEFINE_STRUCT(Point2U, D2D1_POINT_2U)
    ...
    struct RectF
    {
        DXDOTH_DEFINE_STRUCT(RectF, D2D1_RECT_F)
    ...
    struct RectU
    {
        DXDOTH_DEFINE_STRUCT(RectU, D2D1_RECT_U)
    ...
    struct Color
    {
        DXDOTH_DEFINE_STRUCT(Color, D2D1_COLOR_F)
    ...
    struct PixelFormat
    {
        DXDOTH_DEFINE_STRUCT(PixelFormat, D2D1_PIXEL_FORMAT)
    ...
    namespace Dxgi
    {
        ...
        {
            DXDOTH_DEFINE_STRUCT(SampleDescription, DXGI_SAMPLE_DESC)
        ...
        {
            DXDOTH_DEFINE_STRUCT(SwapChainDescription1, DXGI_SWAP_CHAIN_DESC1)
            ...
            explicit SwapChainDescription1(Format const format         = Format::B8G8R8A8_UNORM,
                ...
                AlphaMode(dxdoth::AlphaMode::Unknown),
    ...
    namespace Direct3D
    {
        ...
        {
            DXDOTH_DEFINE_STRUCT(TextureDescription2D, D3D11_TEXTURE2D_DESC)
    ...
    namespace Wic
    {
        ...
        {
            DXDOTH_DEFINE_STRUCT(ImageParameters, WICImageParameters)

            explicit ImageParameters(PixelFormat const & pixelFormat = dxdoth::PixelFormat(Dxgi::Format::B8G8R8A8_UNORM, AlphaMode::Premultiplied),
                                     float dpiX                      = 96.0f,
                                     float dpiY                      = 96.0f,
                                     float top                       = 0.0f,
                                     float left                      = 0.0f,
    ...
    namespace DirectWrite
    {
        struct FontMetrics
        {
            DXDOTH_DEFINE_STRUCT(FontMetrics, DWRITE_FONT_METRICS)
        ...
        struct GlyphMetrics
        {
            DXDOTH_DEFINE_STRUCT(GlyphMetrics, DWRITE_GLYPH_METRICS)
        ...
        struct GlyphOffset
        {
            DXDOTH_DEFINE_STRUCT(GlyphOffset, DWRITE_GLYPH_OFFSET)
        ...
        struct TextRange
        {
            DXDOTH_DEFINE_STRUCT(TextRange, DWRITE_TEXT_RANGE)
        ...
        struct FontFeature
        {
            DXDOTH_DEFINE_STRUCT(FontFeature, DWRITE_FONT_FEATURE)
        ...
        {
            DXDOTH_DEFINE_STRUCT(TypographicFeatures, DWRITE_TYPOGRAPHIC_FEATURES)
        ...
        struct Trimming
        {
            DXDOTH_DEFINE_STRUCT(Trimming, DWRITE_TRIMMING)
        ...
        {
            DXDOTH_DEFINE_STRUCT(ScriptAnalysis, DWRITE_SCRIPT_ANALYSIS)
        ...
        {
            DXDOTH_DEFINE_STRUCT(LineBreakpoint, DWRITE_LINE_BREAKPOINT)
        ...
        {
            DXDOTH_DEFINE_STRUCT(ShapingTextProperties, DWRITE_SHAPING_TEXT_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(ShapingGlyphProperties, DWRITE_SHAPING_GLYPH_PROPERTIES)
        ...
        struct GlyphRun
        {
            DXDOTH_DEFINE_STRUCT(GlyphRun, DWRITE_GLYPH_RUN)
        ...
        {
            DXDOTH_DEFINE_STRUCT(GlyphRunDescription, DWRITE_GLYPH_RUN_DESCRIPTION)
        ...
        struct Underline
        {
            DXDOTH_DEFINE_STRUCT(Underline, DWRITE_UNDERLINE)
        ...
        {
            DXDOTH_DEFINE_STRUCT(Strikethrough, DWRITE_STRIKETHROUGH)
        ...
        struct LineMetrics
        {
            DXDOTH_DEFINE_STRUCT(LineMetrics, DWRITE_LINE_METRICS)
        ...
        {
            DXDOTH_DEFINE_STRUCT(ClusterMetrics, DWRITE_CLUSTER_METRICS)
        ...
        struct TextMetrics
        {
            DXDOTH_DEFINE_STRUCT(TextMetrics, DWRITE_TEXT_METRICS)
        ...
        {
            DXDOTH_DEFINE_STRUCT(InlineObjectMetrics, DWRITE_INLINE_OBJECT_METRICS)
        ...
        {
            DXDOTH_DEFINE_STRUCT(HitTestMetrics, DWRITE_HIT_TEST_METRICS)
    ...
    namespace Direct2D
    {
        ...
        {
            DXDOTH_DEFINE_STRUCT(DrawingStateDescription, D2D1_DRAWING_STATE_DESCRIPTION)
        ...
        {
            DXDOTH_DEFINE_STRUCT(DrawingStateDescription1, D2D1_DRAWING_STATE_DESCRIPTION1)
        ...
        struct ArcSegment
        {
            DXDOTH_DEFINE_STRUCT(ArcSegment, D2D1_ARC_SEGMENT)
        ...
        {
            DXDOTH_DEFINE_STRUCT(BezierSegment, D2D1_BEZIER_SEGMENT)
        ...
        {
            DXDOTH_DEFINE_STRUCT(QuadraticBezierSegment, D2D1_QUADRATIC_BEZIER_SEGMENT)
        ...
        struct Triangle
        {
            DXDOTH_DEFINE_STRUCT(Triangle, D2D1_TRIANGLE)
        ...
        struct RoundedRect
        {
            DXDOTH_DEFINE_STRUCT(RoundedRect, D2D1_ROUNDED_RECT)
        ...
        struct Ellipse
        {
            DXDOTH_DEFINE_STRUCT(Ellipse, D2D1_ELLIPSE)
        ...
        struct GradientStop
        {
            DXDOTH_DEFINE_STRUCT(GradientStop, D2D1_GRADIENT_STOP)

            explicit GradientStop(float const position = 0.0f,
                                  Color const & color  = dxdoth::Color()) :
                Position(position),
                Color(color)
            {}
        ...
        {
            DXDOTH_DEFINE_STRUCT(PrintControlProperties, D2D1_PRINT_CONTROL_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(CreationProperties, D2D1_CREATION_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(BrushProperties, D2D1_BRUSH_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(ImageBrushProperties, D2D1_IMAGE_BRUSH_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(BitmapProperties, D2D1_BITMAP_PROPERTIES)

            explicit BitmapProperties(PixelFormat const & format = dxdoth::PixelFormat(),
        ...
        {
            DXDOTH_DEFINE_STRUCT(BitmapProperties1, D2D1_BITMAP_PROPERTIES1)

            explicit BitmapProperties1(BitmapOptions const options   = BitmapOptions::None,
                                       PixelFormat const & format    = dxdoth::PixelFormat(),
                                       float const dpiX              = 96.0f,
                                       float const dpiY              = 96.0f,
        ...
        {
            DXDOTH_DEFINE_STRUCT(BitmapBrushProperties, D2D1_BITMAP_BRUSH_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(BitmapBrushProperties1, D2D1_BITMAP_BRUSH_PROPERTIES1)
        ...
        {
            DXDOTH_DEFINE_STRUCT(LinearGradientBrushProperties, D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(RadialGradientBrushProperties, D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(StrokeStyleProperties, D2D1_STROKE_STYLE_PROPERTIES)
        ...
        {
            DXDOTH_DEFINE_STRUCT(StrokeStyleProperties1, D2D1_STROKE_STYLE_PROPERTIES1)
        ...
        {
            DXDOTH_DEFINE_STRUCT(LayerParameters, D2D1_LAYER_PARAMETERS)
        ...
        {
            DXDOTH_DEFINE_STRUCT(RenderTargetProperties, D2D1_RENDER_TARGET_PROPERTIES)

            explicit RenderTargetProperties(RenderTargetType const type     = RenderTargetType::Default,
                                            PixelFormat const & pixelFormat = dxdoth::PixelFormat(),
        ...
        {
            DXDOTH_DEFINE_STRUCT(HwndRenderTargetProperties, D2D1_HWND_RENDER_TARGET_PROPERTIES)
        ...
        struct MappedRect
        {
            DXDOTH_DEFINE_STRUCT(MappedRect, D2D1_MAPPED_RECT)
        ...
        {
            DXDOTH_DEFINE_STRUCT(RenderingControls, D2D1_RENDERING_CONTROLS)
        ...
        {
            DXDOTH_DEFINE_STRUCT(EffectInputDescription, D2D1_EFFECT_INPUT_DESCRIPTION)
        ...
        {
            DXDOTH_DEFINE_STRUCT(PointDescription, D2D1_POINT_DESCRIPTION)
    ...
    {
        DXDOTH_DEFINE_CLASS(Stream, Details::Object, IStream)
    };

    struct PropertyBag2 : Details::Object
    {
        DXDOTH_DEFINE_CLASS(PropertyBag2, Details::Object, IPropertyBag2)
    };
    ...
    namespace Dxgi
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(Surface, Details::Object, IDXGISurface)
        };

        struct SwapChain : Details::Object
        {
            DXDOTH_DEFINE_CLASS(SwapChain, Details::Object, IDXGISwapChain)
        ...
        {
            DXDOTH_DEFINE_CLASS(SwapChain1, SwapChain, IDXGISwapChain1)
        ...
        {
            DXDOTH_DEFINE_CLASS(Resource, Details::Object, IDXGIResource)
        ...
        {
            DXDOTH_DEFINE_CLASS(Factory2, Details::Object, IDXGIFactory2)
        ...
        {
            DXDOTH_DEFINE_CLASS(Adapter, Details::Object, IDXGIAdapter)
        ...
        {
            DXDOTH_DEFINE_CLASS(Device, Details::Object, IDXGIDevice)
        ...
        {
            DXDOTH_DEFINE_CLASS(Device1, Device, IDXGIDevice1)
        ...
        {
            DXDOTH_DEFINE_CLASS(Device2, Device1, IDXGIDevice2)
        };
    ...
    namespace Direct3D
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(MultiThread, Details::Object, ID3D10Multithread)
        ...
        {
            DXDOTH_DEFINE_CLASS(Texture2D, Details::Object, ID3D11Texture2D)
        ...
        {
            DXDOTH_DEFINE_CLASS(DeviceContext, Details::Object, ID3D11DeviceContext)
        ...
        {
            DXDOTH_DEFINE_CLASS(DeviceContext1, DeviceContext, ID3D11DeviceContext1)
        };

        struct View : Details::Object
        {
            DXDOTH_DEFINE_CLASS(View, Details::Object, ID3D11View)
        };

        struct RenderTargetView : View
        {
            DXDOTH_DEFINE_CLASS(RenderTargetView, View, ID3D11RenderTargetView)
        };

        struct DepthStencilView : View
        {
            DXDOTH_DEFINE_CLASS(DepthStencilView, View, ID3D11DepthStencilView)
        };

        struct Device : Details::Object
        {
            DXDOTH_DEFINE_CLASS(Device, Details::Object, ID3D11Device)
        ...
        struct Device1 : Device
        {
            DXDOTH_DEFINE_CLASS(Device1, Device, ID3D11Device1)
        };
    ...
    namespace DirectComposition
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(Animation, Details::Object, IDCompositionAnimation)
        };
        #endif
    ...
    namespace Wic
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(Palette, Details::Object, IWICPalette)
        };

        struct BitmapSource : Details::Object
        {
            DXDOTH_DEFINE_CLASS(BitmapSource, Details::Object, IWICBitmapSource)
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapLock, Details::Object, IWICBitmapLock)
        };

        struct Bitmap : BitmapSource
        {
            DXDOTH_DEFINE_CLASS(Bitmap, BitmapSource, IWICBitmap)
        };

        struct BitmapFrameDecode : BitmapSource
        {
            DXDOTH_DEFINE_CLASS(BitmapFrameDecode, BitmapSource, IWICBitmapFrameDecode)
        };

        struct ColorContext : Details::Object
        {
            DXDOTH_DEFINE_CLASS(ColorContext, Details::Object, IWICColorContext)
        };

        struct FormatConverter : BitmapSource
        {
            DXDOTH_DEFINE_CLASS(FormatConverter, BitmapSource, IWICFormatConverter);
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapFrameEncode, Details::Object, IWICBitmapFrameEncode)
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapEncoder, Details::Object, IWICBitmapEncoder)

            void Initialize(dxdoth::Stream const & stream,
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapDecoder, Details::Object, IWICBitmapDecoder)

            auto GetFrameCount() const -> unsigned;
            auto GetFrame(unsigned index = 0) const -> BitmapFrameDecode;
        };

        struct Stream : dxdoth::Stream
        {
            DXDOTH_DEFINE_CLASS(Stream, dxdoth::Stream, IWICStream)
        ...
        {
            DXDOTH_DEFINE_CLASS(Factory, Details::Object, IWICImagingFactory)
            ...
            auto CreateDecoderFromStream(dxdoth::Stream const & stream,
        ...
        {
            DXDOTH_DEFINE_CLASS(ImageEncoder, Details::Object, IWICImageEncoder)
        ...
        {
            DXDOTH_DEFINE_CLASS(Factory2, Factory, IWICImagingFactory2)
    ...
    namespace Wam
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(TimerClientEventHandler, Details::Object, IUIAnimationTimerClientEventHandler)
        ...
        {
            DXDOTH_DEFINE_CLASS(TimerUpdateHandler, Details::Object, IUIAnimationTimerUpdateHandler)
        ...
        {
            DXDOTH_DEFINE_CLASS(TimerEventHandler, Details::Object, IUIAnimationTimerEventHandler)
        ...
        {
            DXDOTH_DEFINE_CLASS(Timer, Details::Object, IUIAnimationTimer)
        ...
        {
            DXDOTH_DEFINE_CLASS(LoopIterationChangeHandler, Details::Object, IUIAnimationLoopIterationChangeHandler2)
        ...
        {
            DXDOTH_DEFINE_CLASS(StoryboardEventHandler, Details::Object, IUIAnimationStoryboardEventHandler2)
        ...
        {
            DXDOTH_DEFINE_CLASS(Storyboard, Details::Object, IUIAnimationStoryboard2)
        ...
        {
            DXDOTH_DEFINE_CLASS(VariableChangeHandler, Details::Object, IUIAnimationVariableChangeHandler2)
        ...
        {
            DXDOTH_DEFINE_CLASS(VariableIntegerChangeHandler, Details::Object, IUIAnimationVariableIntegerChangeHandler2)
        ...
        {
            DXDOTH_DEFINE_CLASS(VariableCurveChangeHandler, Details::Object, IUIAnimationVariableCurveChangeHandler2)
        ...
        {
            DXDOTH_DEFINE_CLASS(Variable, Details::Object, IUIAnimationVariable2)
        ...
        {
            DXDOTH_DEFINE_CLASS(Transition, Details::Object, IUIAnimationTransition2)
        ...
        {
            DXDOTH_DEFINE_CLASS(ManagerEventHandler, Details::Object, IUIAnimationManagerEventHandler2)
        ...
        {
            DXDOTH_DEFINE_CLASS(PriorityComparison, Details::Object, IUIAnimationPriorityComparison2)
        ...
        {
            DXDOTH_DEFINE_CLASS(Manager, Details::Object, IUIAnimationManager2)
        ...
        {
            DXDOTH_DEFINE_CLASS(TransitionLibrary, Details::Object, IUIAnimationTransitionLibrary2)
        ...
        {
            DXDOTH_DEFINE_CLASS(PrimitiveInterpolation, Details::Object, IUIAnimationPrimitiveInterpolation)
        ...
        {
            DXDOTH_DEFINE_CLASS(Interpolator, Details::Object, IUIAnimationInterpolator2)
        ...
        {
            DXDOTH_DEFINE_CLASS(TransitionFactory, Details::Object, IUIAnimationTransitionFactory2)
    ...
    namespace DirectWrite
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(FontFileStream, Details::Object, IDWriteFontFileStream)
        };

        struct FontFileLoader : Details::Object
        {
            DXDOTH_DEFINE_CLASS(FontFileLoader, Details::Object, IDWriteFontFileLoader)
        };

        struct LocalFontFileLoader : FontFileLoader
        {
            DXDOTH_DEFINE_CLASS(LocalFontFileLoader, FontFileLoader, IDWriteLocalFontFileLoader)
        };

        struct FontFile : Details::Object
        {
            DXDOTH_DEFINE_CLASS(FontFile, Details::Object, IDWriteFontFile)
        };

        struct FontFace : Details::Object
        {
            DXDOTH_DEFINE_CLASS(FontFace, Details::Object, IDWriteFontFace)
        };

        struct FontCollectionLoader : Details::Object
        {
            DXDOTH_DEFINE_CLASS(FontCollectionLoader, Details::Object, IDWriteFontCollectionLoader)
        };

        struct FontFileEnumerator : Details::Object
        {
            DXDOTH_DEFINE_CLASS(FontFileEnumerator, Details::Object, IDWriteFontFileEnumerator)
        };

        struct LocalizedStrings : Details::Object
        {
            DXDOTH_DEFINE_CLASS(LocalizedStrings, Details::Object, IDWriteLocalizedStrings)
        ...
        {
            DXDOTH_DEFINE_CLASS(Font, Details::Object, IDWriteFont)
        };

        struct FontList : Details::Object
        {
            DXDOTH_DEFINE_CLASS(FontList, Details::Object, IDWriteFontList)
        ...
        {
            DXDOTH_DEFINE_CLASS(FontFamily, FontList, IDWriteFontFamily)
        ...
        struct FontCollection : Details::Object
        {
            ...
            DXDOTH_DEFINE_CLASS(FontCollection, Details::Object, IDWriteFontCollection)
        ...
        {
            DXDOTH_DEFINE_CLASS(InlineObject, Details::Object, IDWriteInlineObject)
        };

        struct Typography : Details::Object
        {
            DXDOTH_DEFINE_CLASS(Typography, Details::Object, IDWriteTypography)
        };

        struct GdiInterop : Details::Object
        {
            DXDOTH_DEFINE_CLASS(GdiInterop, Details::Object, IDWriteGdiInterop)
        };

        struct TextAnalyzer : Details::Object
        {
            DXDOTH_DEFINE_CLASS(TextAnalyzer, Details::Object, IDWriteTextAnalyzer)
        };

        struct NumberSubstitution : Details::Object
        {
            DXDOTH_DEFINE_CLASS(NumberSubstitution, Details::Object, IDWriteNumberSubstitution)
        };

        struct GlyphRunAnalysis : Details::Object
        {
            DXDOTH_DEFINE_CLASS(GlyphRunAnalysis, Details::Object, IDWriteGlyphRunAnalysis)
        };

        struct RenderingParams : Details::Object
        {
            DXDOTH_DEFINE_CLASS(RenderingParams, Details::Object, IDWriteRenderingParams)
        ...
        {
            DXDOTH_DEFINE_CLASS(TextFormat, Details::Object, IDWriteTextFormat)
        ...
        {
            DXDOTH_DEFINE_CLASS(TextLayout, TextFormat, IDWriteTextLayout)
        ...
        struct Factory : Details::Object
        {
            DXDOTH_DEFINE_CLASS(Factory, Details::Object, IDWriteFactory)
        ...
        {
            DXDOTH_DEFINE_CLASS(Factory1, Factory, IDWriteFactory1)
        };

        struct __declspec(uuid("0439fc60-ca44-4994-8dee-3a9af7b732ec")) Factory2 : Factory1
        {
            DXDOTH_DEFINE_CLASS(Factory2, Factory1, IDWriteFactory2)
        };
    ...
    namespace Direct2D
    {
        ...
        {
            DXDOTH_DEFINE_CLASS(SimplifiedGeometrySink, Details::Object, ID2D1SimplifiedGeometrySink)
        ...
        {
            DXDOTH_DEFINE_CLASS(TessellationSink, Details::Object, ID2D1TessellationSink)
        ...
        struct Resource : Details::Object
        {
            DXDOTH_DEFINE_CLASS(Resource, Details::Object, ID2D1Resource)
        ...
        {
            DXDOTH_DEFINE_CLASS(Image, Resource, ID2D1Image)
        };

        struct __declspec(uuid("a2296057-ea42-4099-983b-539fb6505426")) Bitmap : Image
        {
            DXDOTH_DEFINE_CLASS(Bitmap, Image, ID2D1Bitmap)
        ...
        {
            DXDOTH_DEFINE_CLASS(ColorContext, Resource, ID2D1ColorContext)
        ...
        {
            DXDOTH_DEFINE_CLASS(Bitmap1, Bitmap, ID2D1Bitmap1)
        ...
        {
            DXDOTH_DEFINE_CLASS(GradientStopCollection, Resource, ID2D1GradientStopCollection)
        ...
        {
            DXDOTH_DEFINE_CLASS(GradientStopCollection1, GradientStopCollection, ID2D1GradientStopCollection1)
        ...
        {
            DXDOTH_DEFINE_CLASS(Brush, Resource, ID2D1Brush)
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapBrush, Brush, ID2D1BitmapBrush)
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapBrush1, BitmapBrush, ID2D1BitmapBrush1)
        ...
        {
            DXDOTH_DEFINE_CLASS(SolidColorBrush, Brush, ID2D1SolidColorBrush)
        ...
        {
            DXDOTH_DEFINE_CLASS(LinearGradientBrush, Brush, ID2D1LinearGradientBrush)
        ...
        {
            DXDOTH_DEFINE_CLASS(RadialGradientBrush, Brush, ID2D1RadialGradientBrush)
        ...
        {
            DXDOTH_DEFINE_CLASS(StrokeStyle, Resource, ID2D1StrokeStyle)
        ...
        {
            DXDOTH_DEFINE_CLASS(StrokeStyle1, StrokeStyle, ID2D1StrokeStyle1)
        ...
        {
            DXDOTH_DEFINE_CLASS(Geometry, Resource, ID2D1Geometry)
        ...
        {
            DXDOTH_DEFINE_CLASS(RectangleGeometry, Geometry, ID2D1RectangleGeometry)
        ...
        {
            DXDOTH_DEFINE_CLASS(RoundedRectangleGeometry, Geometry, ID2D1RoundedRectangleGeometry)
        ...
        {
            DXDOTH_DEFINE_CLASS(EllipseGeometry, Geometry, ID2D1EllipseGeometry)
        ...
        {
            DXDOTH_DEFINE_CLASS(GeometryGroup, Geometry, ID2D1GeometryGroup)
        ...
        {
            DXDOTH_DEFINE_CLASS(TransformedGeometry, Geometry, ID2D1TransformedGeometry)
        ...
        {
            DXDOTH_DEFINE_CLASS(GeometrySink, SimplifiedGeometrySink, ID2D1GeometrySink)
        ...
        {
            DXDOTH_DEFINE_CLASS(PathGeometry, Geometry, ID2D1PathGeometry)
        ...
        {
            DXDOTH_DEFINE_CLASS(PathGeometry1, PathGeometry, ID2D1PathGeometry1)
        ...
        {
            DXDOTH_DEFINE_CLASS(Properties, Details::Object, ID2D1Properties)
        };

        struct Effect : Properties
        {
            DXDOTH_DEFINE_CLASS(Effect, Properties, ID2D1Effect)
        ...
        {
            DXDOTH_DEFINE_CLASS(Mesh, Resource, ID2D1Mesh)
        ...
        {
            DXDOTH_DEFINE_CLASS(Layer, Resource, ID2D1Layer)
        ...
        {
            DXDOTH_DEFINE_CLASS(DrawingStateBlock, Resource, ID2D1DrawingStateBlock)
        ...
        {
            DXDOTH_DEFINE_CLASS(DrawingStateBlock1, DrawingStateBlock, ID2D1DrawingStateBlock1)
        ...
        {
            DXDOTH_DEFINE_CLASS(RenderTarget, Resource, ID2D1RenderTarget)
        ...
        {
            DXDOTH_DEFINE_CLASS(BitmapRenderTarget, RenderTarget, ID2D1BitmapRenderTarget)
        ...
        {
            DXDOTH_DEFINE_CLASS(HwndRenderTarget, RenderTarget, ID2D1HwndRenderTarget)
        ...
        {
            DXDOTH_DEFINE_CLASS(DcRenderTarget, RenderTarget, ID2D1DCRenderTarget)
        ...
        {
            DXDOTH_DEFINE_CLASS(GdiMetafileSink, Details::Object, ID2D1GdiMetafileSink)
        };

        struct GdiMetafile : Resource
        {
            DXDOTH_DEFINE_CLASS(GdiMetafile, Resource, ID2D1GdiMetafile)
        ...
        {
            DXDOTH_DEFINE_CLASS(CommandSink, Details::Object, ID2D1CommandSink)
        };

        struct CommandList : Image
        {
            DXDOTH_DEFINE_CLASS(CommandList, Image, ID2D1CommandList)
        ...
        {
            DXDOTH_DEFINE_CLASS(PrintControl, Details::Object, ID2D1PrintControl)
        ...
        {
            DXDOTH_DEFINE_CLASS(ImageBrush, Brush, ID2D1ImageBrush)
        ...
        {
            DXDOTH_DEFINE_CLASS(DeviceContext, RenderTarget, ID2D1DeviceContext)
        ...
        {
            DXDOTH_DEFINE_CLASS(Device, Resource, ID2D1Device)
        ...
        struct MultiThread : Details::Object
        {
            DXDOTH_DEFINE_CLASS(MultiThread, Details::Object, ID2D1Multithread)
        ...
        struct Factory : Details::Object
        {
            DXDOTH_DEFINE_CLASS(Factory, Details::Object, ID2D1Factory)
        ...
        {
            DXDOTH_DEFINE_CLASS(Factory1, Factory, ID2D1Factory1)
        ...
        {
            DXDOTH_DEFINE_CLASS(Factory2, Factory1, ID2D1Factory2)
        };
    ...
    namespace Wic
    {
        ...
        inline void BitmapEncoder::Initialize(dxdoth::Stream const & stream,
        ...
        inline auto Factory::CreateDecoderFromStream(dxdoth::Stream const & stream,
